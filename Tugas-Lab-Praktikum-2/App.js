...
export default function App() {
    ...
    return (
        <View style={styles.container}>
            ...
            <Image source={require('./assets/circle2.png')} style={styles.circle2} />
            {/* Scroll Settings */}
            <ScrollView
            ...
            >
                ...
                <View style={styles.tasksWrapper}>
                    ...
                    <View style={styles.contents}>
                        ...
                        <TouchableOpacity>
                            ...
                            <Image source={require('./assets/inspiring.png')} style={styles.inspiring} />
                            <Text style={styles.sectionTitle}>Portal Student</Text>
                            <Text style={styles.sectionSubTitle}>IBIK</Text>
                ...
                <View style={styles.items}>
                    ...
                    <TouchableOpacity style={styles.startButton}>
                        <Text style={styles.start}>Get Start</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
